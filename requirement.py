We have spelt out the functional and non-fuctional requirement our software
will need to function.

Fuctional Requirements: With the assumption that we already have the data.
...
* Interacts with the central system of the hospitals to get information on the
